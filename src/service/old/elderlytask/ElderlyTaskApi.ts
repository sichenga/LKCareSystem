...
export const elderlyTaskdelete = (id: number) => del(`/api/elderlyTask/delete/${id}`)
// 老人任务添加 /api/elderlyTask/add
export const elderlyTaskadd = (data: AddElderlyTaskDto) => post('/api/elderlyTask/add', data)
