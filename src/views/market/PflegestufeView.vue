<template>
   ...
   <el-card style="max-width: 100%;margin-top: 20px;">
      <el-button type="primary" style="margin-bottom: 20px;" @click="isdialog = true">新增护理等级变更</el-button>
      <PfleGestufeDialog v-if="isdialog" @close="close"></PfleGestufeDialog>
      <!-- 表格 -->
...
const PfleGestufeDialog = defineAsyncComponent(() => import('@/components/dialog/market/PfleGestufeDialog.vue'))
