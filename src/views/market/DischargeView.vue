<template>
   ...
   <el-card style="max-width: 100%">
      <el-form ref="Refdischarge" :inline="true" :model="formInline" class="demo-form-inline">
   ...
   <el-card style="max-width: 100%" class="card">
      ...
      <Pagination @page="pageChenge" @psize="pageSizeChenge" :page="formInline.page" :psize="formInline.pageSize"
         :total="data.total">
      </Pagination>
      <!-- 新增 -->
      <DischargeDialog v-if="isdialog" :id="idetit" @close="close"></DischargeDialog>
   </el-card>
</template>
