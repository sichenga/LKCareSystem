  ...
  <el-card style="max-width: 100%" class="card">
    ...
    <MayTable :tableData="data.tableData" :tableItem="data.tableItem">
      <template #operate="{ data }">
        <el-button type="primary" size="small" text @click="handleEdit(data)">编辑</el-button>
        <el-button type="primary" size="small" text @click="handleDelete(data.id)">删除</el-button>
      </template>
    </MayTable>
    <Pagination :total="50"></Pagination>
    <!-- 新增 -->
    <CooperativeDialog @close="close" v-if="isdialog"></CooperativeDialog>
    <!-- 积分奖励 -->
