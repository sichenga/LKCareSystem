<template>
    ...
    <el-card class="table">
        ...
        <MayTable :tableData="data.tableData" :tableItem="data.tableItem">
            <template #operate>
                <el-button type="primary" size="small" link @click="hospital">出院结算</el-button>
        ...
        <!-- 缴费结算 -->
        <HospitalDialog @close="close" v-if="isdialog"></HospitalDialog>
    </el-card>
</template>
...
import HospitalDialog from "@/components/dialog/HospitalDialog.vue"
