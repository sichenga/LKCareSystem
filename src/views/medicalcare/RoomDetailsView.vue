...
<template>
    ...
    <div class="user_content">
      ...
      >
        <div class="box">
          ...
          <div>
            <el-form-item label="记录人">{{ form?.addAccountName }}</el-form-item>
  ...
  <el-card style="margin-top: 15px">
    <el-form label-position="left" label-width="auto" style="max-width: 600px">
      <el-form-item label="查房记录内容"> </el-form-item>
      <el-form-item label="| 基本情况"> </el-form-item>
      ...
      <el-form-item label="| 生命特征"> </el-form-item>
      ...
      <el-form-item label="| 医生建议"> </el-form-item>
      <el-form-item :label="form.suggest"> </el-form-item>
    </el-form>
