<template>
    <!--新增出院申请  -->
    <el-dialog v-model="dialogVisible" :title="ruleForm.id == 0 ? '新增出院申请' : '编辑出院申请'" width="500" @close="close">
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="ruleForm" :rules="rules" label-width="auto"
            ...
            <el-form-item label="预计时间：" prop="expectDate">
                <MayTimePicker :format="'YYYY-MM-DD'" :valueFormat="'YYYY-MM-DD'" @change="handlchange" :remtime="time">
                </MayTimePicker>
            </el-form-item>
        </el-form>
        <template #footer>
    ...
    <!-- 老人 -->
    <OldDischarge v-if="olddialog" @list="list" @closes="closes"></OldDischarge>
</template>
...
import { dischargeAdd, dischargeGet, dischargeUpdate } from '@/service/market/DischargeApi'
...
const list = (list: any) => {
    ...
    data.value = list
    ruleForm.elderlyId = data.value.id
}
