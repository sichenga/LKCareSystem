...
<template>
  <el-dialog v-model="dialogVisible" title="选择老人" width="50%" @close="close">
    ...
    <MayTable @serveListIs="serveListIs" :tableData="data.tableData" :tableItem="data.tableItem" :isoperate="isoperate"
              :identifier="identifier" :isMultiple="porps.isMultiple">
