<template>
  <el-dialog v-model="dialogVisible" title="新增床位" width="500" @close="close">
    <el-form
      ref="ruleFormRef"
    ...
    >
      ...
      <el-form-item label="床位号：" prop="name">
        <el-input v-model="ruleForm.name" style="width: 300px" placeholder="请输入床位号" />
      </el-form-item>
      <el-form-item label="床位月价格：" prop="price">
        <el-input v-model="ruleForm.price" style="width: 300px" placeholder="请输入床位月价格" />
      </el-form-item>
    </el-form>
    <template #footer>
