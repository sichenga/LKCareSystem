<template>
  <el-dialog v-model="dialogVisible" :title="props.ids ? '编辑咨询登记' : '新增咨询登记'" width="500" @close="close">
    <el-form ref="ruleFormRef" style="max-width: 600px" :model="ruleForm" :rules="rules" label-width="auto"
      ...
      <el-form-item label="与老人关系:" prop="relation">
        <el-select v-model="ruleForm.relation" placeholder="请选择" style="width: 300px">
          <el-option v-for="item in addresslist" :key="item.id" :label="item.lable" :value="item.lable" />
        </el-select>
      </el-form-item>
      <el-form-item label="策划回访日期:" prop="visitTime">
        <MayTimePicker @change="handlchange" :remtime="time"></MayTimePicker>
      </el-form-item>
...
import { questionAdd, getquestionlist,questionUpdate } from '@/service/market/marketApi'
...
const rules = reactive<FormRules<any>>({
  name: [
    { required: true, message: '请输入资讯人', trigger: 'blur' },
  ],
  mobile: [
...
//与老人关系
const addresslist = ref([{ lable: '父子关系', id: 1 }, { lable: '父女关系', id: 2 }, { lable: '母子关系', id: 3 }, { lable: '母女关系', id: 4 }, { lable: '其他', id: 5 },])
//选择时间
