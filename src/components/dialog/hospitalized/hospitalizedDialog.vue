<template>
    <el-dialog v-model="dialogVisible" title="添加服务" width="500" @close="close">
            <MayTable :tableData="data.tableData" :tableItem="data.tableItem" :isoperate="false" :isMultiple="true" @serveListIs="serveLists">
