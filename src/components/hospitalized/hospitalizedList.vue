        ...
        <div class="top-body">
            <div>
                <div class="content-size">
                    <el-image style="width: 50px; height: 50px;border-radius: 50%" :src="Image + DataElder.photo"
                        fit="cover" />
                    <div class="size-cont">
                        <div>
                            <div>老人姓名：</div>
            ...
            <el-form ref="ruleFormRef" style="max-width: 400px" :model="ruleForm" :rules="rules" label-width="auto"
                ...
                <div class="margin-szie">
                    <el-form-item label="选择床位:" prop="begId">
                        <el-select v-model="ruleForm.begId" placeholder="请选择">
                            <el-option v-for="item in DataBedsList" :key="item.id" :label="item.name"
                                :value="item.id" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="床位单价:" prop="begPrice">
                        <el-input-number controls-position="right" v-model="ruleForm.begPrice"   :min="0"
                        :max="10000000000" placeholder="200/天" />

                    </el-form-item>
                    <el-form-item label="入住天数:" prop="days">
                        <el-input-number controls-position="right" v-model="ruleForm.days"  :min="0"
                ...
                <div class="margin-szie">
                    <el-form-item label="套餐单价:" prop="foodPrice">
                        ...
                        :max="10000000000" v-model="ruleForm.foodPrice" placeholder="25/天" />
                    </el-form-item>
                </div>
                <div class="font-sizes ">
                    <span class="color-szie">▋</span>
                ...
                <div class="margin-szie">
                    <el-form-item label="护理费:" prop="servicePrice">
                        <el-input-number controls-position="right" v-model="ruleForm.servicePrice" placeholder="100/天" :min="1"
                        :max="10000000000" />
                    </el-form-item>
                    <el-button type="primary" style="margin-bottom: 20px;" @click="add">添加服务</el-button>

                    <hospitalizedDialog v-if="dialogVisible" @close="handlClose" @serveList="serveList"></hospitalizedDialog>
                ...
                <div class="margin-szie">
                    <el-form-item label="押金:" prop="cashPledge">
                        <el-input-number controls-position="right" v-model="ruleForm.cashPledge" placeholder="请输入" :min="0"
                        :max="10000000000"/>
                    </el-form-item>
                    <el-form-item label="一次性生活费 :" prop="livingPrice">
                        <el-input-number controls-position="right" v-model="ruleForm.livingPrice" placeholder="请输入" :min="0"
                        :max="10000000000"/>
                    </el-form-item>
                </div>
                <div class="font-sizes ">
                ...
                <div class="margin-szie">
                    <el-form-item label="入院费用核定天数:" prop="payDays">
                        <el-input-number controls-position="right" v-model="ruleForm.payDays" placeholder="请输入" />
                    </el-form-item>
                </div>
...
import { ref, reactive, toRefs, onMounted, defineAsyncComponent, defineEmits,inject } from 'vue'
