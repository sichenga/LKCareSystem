    ...
    <div class="content-sizes">
      <el-form ref="ruleFormRef" :model="ruleForm" class="demo-ruleForm" size status-icon>
        <div class="font-sizes">
          ...
          <span class="option"
            >({{ ruleForm.startDate }} 至 {{  overTime(ruleForm.startDate, ruleForm.days) }})</span
          >
        </div>
        ...
        <el-form-item class="button-size">
          ...
          <el-button type="primary" @click="submitForm(1)"> 保存暂不提交 </el-button>
          <el-button type="primary" @click="submitForm(2)"> 保存并提交 </el-button>
